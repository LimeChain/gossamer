...
func Test_BuildTrie_RootHashTest(t *testing.T) {
	root, err := hex.DecodeString("dc4887669c2a6b3462e9557aa3105a66a02b6ec3b21784613de78c95dc3cbbe0")
	if err != nil {
		panic(err)
	}
	...
	// Assert that the original `root` matches the latest generated root hash from the rebuilt trie.
	require.Equal(t, root, rootHash[:])
}
